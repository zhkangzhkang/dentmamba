...
if __name__ == '__main__':
    model = RTDETR('/home/File/wc123/RTDETR-20251008/ultralytics/cfg/models/rt-detr/rtdetr-r18.yaml')
    model.load('/home/File/wc123/RTDETR-20251008/weights/weights/rtdetr-r18.pt') # loading pretrain weights
    model.train(data='/home/File/wc123/RTDETR-20251008/dataset/data.yaml',
                cache=False,
                imgsz=640,
                epochs=300,
                ...
                # resume='/home/File/wc123/RTDETR-20251008/runs/train/exp2/weights/last.pt path', # last.pt path
                project='/home/File/wc123/RTDETR-20251008/runs/train',
                name='exp',
                )